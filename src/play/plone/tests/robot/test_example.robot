...
#
#  $ bin/test -s play.plone -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src play.plone.testing.PLAY_PLONE_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/play/plone/tests/robot/test_example.robot
#
